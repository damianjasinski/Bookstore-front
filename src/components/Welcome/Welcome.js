    ...
    <div class="container mx-auto">
      <div className="row position-absolute top-50 start-50 translate-middle">
        <div className="border rounded  text-center bg-light">
          ...
          <h1 className="mt-4 px-5">First time? Signup!</h1>
          <h4 className="mx-5 px-5 pb-5">or login :-)</h4>
          <a type="button" href = "/login" className="mx-1 fs-5 mb-5 p-2 btn btn-primary">Login</a>
          <a type="button" href = '/Signup' className="mx-1 fs-5 mb-5 p-2 btn btn-success">Signup</a>
        </div>
      </div>
    </div>
  );
